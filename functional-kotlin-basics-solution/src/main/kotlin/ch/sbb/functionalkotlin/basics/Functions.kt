...
fun addOneProvider(): (Int) -> Int = { x -> x + 1 }
...
fun isEven(value: Float, f: (Float) -> Int): Boolean = f(value) % 2 == 0
...
fun valueLength(map: Map<String, String>): (String) -> Int = { key ->  map.getOrDefault(key, "").length }
...
val countOccurrence: (Char) -> Int = { char: Char -> countOccurrence("The quick brown fox jumps over the hedge", char) }
